...
def effect_show(rawimg_path:str,label_path:str,model:NestedUNet)->float:
    ...
    if model.training==True:
        model.eval()
    with torch.no_grad():
        pred:torch.Tensor = model.multi_predict(input)[3]
    pred.round_()
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('D:/microsoft_PBL/attention_unet/trained_models/unet++_14_level4_9606.pth',map_location='cpu'))
